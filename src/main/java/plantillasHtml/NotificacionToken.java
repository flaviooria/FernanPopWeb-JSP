...
public class NotificacionToken {
    public static String obtenerHtml(String nombreUsuario, String tokenUsuario) {
        return  "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "                color: #293241;text-align: justify;\">Hola "+ nombreUsuario +","+ "<br>Para terminar de configurar tu cuenta y empezar a usar FernanPop, confirma que te has registrado correctamente.</p></td>\n" +
                "        </tr>\n" +
                "        <tr>\n" +
                "            <td style=\"padding: 1em;\">\n" +
                "                <p style=\" \n" +
                "                margin-top: 5px;\n" +
                "                font-family: 'Quicksand', sans-serif;\n" +
                "                color: #293241;\">Copia el siguiente token para validarte.</p>\n" +
                "            </td>\n" +
                "            <tr>\n" +
                "                <td style=\"\n" +
