...
<header id="inicio">
    <div class="hero">
        ...
        <div class="hero-register animate__animated animate__fadeIn animate__slower animate-delay-3s">
            <form id="form-login" method="get" action="verificarLogin.jsp">
                <h3>Inciar Sesión</h3>
                ...
                <p class="form-register">Aun no estas registrado,hazlo aquí: <a class="form-register-link" href="../index.jsp">Registrarse</a></p>
                <div class="spinner">
