<%-- 
    Document   : error
    Created on : Jul 3, 2021, 8:17:48 PM
    Author     : 2097k
--%>
...
<div class="container">
    ...
    <div class="hero">
        <div class="hero__alert">
            ...
            %>
            <h3 class="hero__alert-info"><%=session.getAttribute("error")%></h3>
            <%} else {%>
            <h3 class="hero__alert-info">Ups!, Creo que no encontraste lo que buscabas.</h3>
            <%}%>
            <a href="../index.jsp" class="hero__alert-link">Haz click aquí.</a>
        </div>
    </div>
    <!-- Footer -->
    <footer>
